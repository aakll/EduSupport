...
const programs = [
  {
    ...
    image: "https://th.bing.com/th/id/R.ebe4fcfce02d27babc125b01a3c74945?rik=rgySSwULdNe80w&pid=ImgRaw&r=0",
  },
  {
    name: "ULYP",
    desc: "Undergraduate Lebanon Youth Program for top Lebanese students.",
    path: "/scholarships/ulyp",
    image: "https://tse1.mm.bing.net/th/id/OIP.d-_rNnvbWdzXi6UKQ84aYQHaHa?rs=1&pid=ImgDetMain&o=7&rm=3",
  },
  {
    name: "LIFE",
    desc: "Lebanese International Future Education global opportunities.",
    path: "/scholarships/life",
    image: "https://www.scholarhunter.com/wp-content/uploads/2023/10/LIFE-Scholarships-programme-768x576.jpg",
  },
  {
    name: "Habeeb",
    desc: "Community-driven fund for underprivileged high school graduates.",
    path: "/scholarships/habeeb",
    image: "https://static.wixstatic.com/media/d895be_806800b2b18f4176abd0b8e29ad1967a~mv2.png/v1/fill/w_429,h_78,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/d895be_806800b2b18f4176abd0b8e29ad1967a~mv2.png",
  },
  {
    name: "Tomooh",
    desc: "Ambition-focused mentorship and financial aid program.",
    path: "/scholarships/tomooh",
    image: "https://www.middleeast.pepsico.com/images/middleeastksalibraries/lebanon/tomooh-scholarship.png?Status=Master",
  },
  {
    name: "Tarraf",
    desc: "Bridging higher education gaps for rural communities.",
    path: "/scholarships/tarraf",
    image: "https://cdn.firespring.com/images/880a2126-e1e4-4421-8500-d3da4fb69cf7.png",
  },
];
    ...
    <div className="min-h-screen bg-white font-sans text-black">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex items-center gap-4 mb-12">
            ...
            <span className="font-black text-xl uppercase tracking-widest text-[#16a34a]">All Opportunities</span>
            <div className="h-1 bg-black flex-grow"></div>
        </div>
        ...
        <section id="all-scholarships">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {scholarships.map((s) => (
              ...
              >
                <h2 className="font-black text-xl text-black mb-1 uppercase">{s.title}</h2>
