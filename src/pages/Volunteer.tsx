...
export default function Volunteer() {
  ...
  useEffect(() => {
    if (location.state?.guestWarning) setIsGuest(true);
  ...
  return (
    ...
    <div className="min-h-screen bg-white page-enter">
      {isGuest && <GuestBanner redirectTo="/volunteer" />}
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 group-hover:text-red-600 transition-colors">
                  Help Students Know about Scholarships & their Application
                  Process
                </h2>
                <p className="text-sm text-slate-500 mt-1">
                  Click to learn more and apply as a mentor
                </p>
              </div>
            </div>
