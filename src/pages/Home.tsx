        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto animate-fade-in-up-delay">
              Empowering Lebanese students to find scholarships, universities,
              and opportunities
            </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="text-gray-600">
                      Discover scholarships and opportunities for your future
                    </p>
                  </div>
                  <svg
                    className="w-6 h-6 text-gray-400 group-hover:text-[#4CAF50] group-hover:translate-x-2 transition-all"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="text-gray-600">
                      Access funding and resources for your degree
                    </p>
                  </div>
                  <svg
                    className="w-6 h-6 text-gray-400 group-hover:text-[#42A5F5] group-hover:translate-x-2 transition-all"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="text-gray-600">
                      Join our mission to support Lebanese students
                    </p>
                  </div>
                  <svg
                    className="w-6 h-6 text-gray-400 group-hover:text-[#81C784] group-hover:translate-x-2 transition-all"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed">
                  EduSupport is dedicated to empowering Lebanese students with
                  access to scholarships, universities, and career
                  opportunities. We believe every student deserves a chance to
                  succeed.
                </p>
              </div>
                  ...
                  {teamMembers.map((member) => (
                    <div key={member.name} className="group relative">
                      ...
                      <div className="absolute inset-0 bg-slate-900/95 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center p-2 pointer-events-none group-hover:pointer-events-auto">
                        <p className="text-xs text-[#4CAF50] mb-1">
                          📧 {member.email}
                        </p>
                        <p className="text-xs text-[#42A5F5]">
                          🔗 {member.linkedin}
                        </p>
                      </div>
                    </div>
            ...
            <div className="border-t border-gray-700 mt-12 pt-8 text-center">
              <p className="text-gray-400 text-sm">
                ...
                Made with ❤️ for Lebanese students.
              </p>
            </div>
          </div>
        </footer>
